            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className={`mb-20 text-center ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
                    <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/5 px-4 py-2 backdrop-blur-sm">
                        ...
                        <span className="text-xs font-medium tracking-widest text-cyan-400">CLIENT SUCCESS</span>
                    </div>
                    <h2 className="mb-6 text-5xl font-bold tracking-tight text-white md:text-6xl lg:text-7xl">
                        Trusted by <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-white">industry leaders</span>
                    </h2>
                </div>

                {/* Testimonial Carousel */}
                <div className={`relative ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
                    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent p-12 backdrop-blur-sm lg:p-10">

                        {/* Quote Icon */}
                        <div className="absolute top-8 left-8 text-6xl text-cyan-400/20">❝</div>
                        ...
                        <div className="relative min-h-[300px] flex flex-col justify-center">
                            {testimonials.map((testimonial, index) => (
                                ...
                                >
                                    <p className="mb-8 text-2xl font-light leading-relaxed text-gray-200 lg:text-3xl">
                                        "{testimonial.quote}"
                                    </p>
                                    <div>
