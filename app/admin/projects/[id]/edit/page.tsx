...
export default function EditProjectPage() {
  ...
  if (fetching) return <div className="text-white text-center py-20">Loading...</div>;
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/2 border border-white/10 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            <input type="text" value={newResult.metric} onChange={(e) => setNewResult({ ...newResult, metric: e.target.value })}
              className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-[#C0C0C0]/50" placeholder="Metric" />
            <input type="text" value={newResult.label} onChange={(e) => setNewResult({ ...newResult, label: e.target.value })}
              className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-[#C0C0C0]/50" placeholder="Label" />
          </div>
